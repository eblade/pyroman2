...
class Page(Element):
    def init(self):
        ...
        self.space_width = self._params.get('space-width',
                                            self.parent.space_width)
        self.margin_left = self._params.get('margin-left',
                                            self.parent.margin_left)
        self.margin_right = self._params.get('margin-right',
                                             self.parent.margin_right)
        self.margin_top = self._params.get('margin-top',
...
class Layout(Element):
    ...
    # p1 is the upper-left corner of the area, measured from the upper-left
    # corner of the page
    # p2 is the lower-right corner of the area, measured from the upper-left
    # corner of the page
